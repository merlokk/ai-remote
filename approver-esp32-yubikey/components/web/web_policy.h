...
//
// `<cstdint>` and nothing else, which is the shape the Wi-Fi policy, the bus
// link, the state ranking and the LED's arithmetic already have (§10.11) — and
// here it buys the same thing: the one rule that keeps this server from crashing
// the device is a comparison, and a comparison can be tested.
//
