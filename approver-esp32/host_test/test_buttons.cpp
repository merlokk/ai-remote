// The three buttons (CLAUDE.md §10.1, §10.15).
//
...
//
//   * **`active_low` per button**, because §10.1 found `PWR` wired the other
//     way round on this board. A driver that assumed one polarity reported a
//     button pressed for the whole uptime;
//   * **`HeldFor`**, which is §10.15's config restore: five blind seconds at
//     boot with no screen to give feedback on.
